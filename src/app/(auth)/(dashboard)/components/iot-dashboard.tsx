...
export default function IoTDashboard() {
  ...
  useEffect(() => {
    const dataInterval = setInterval(() => {
      ...
      const temperature = Math.floor(Math.random() * 40) + 15; // 15-55°C
      const alertCondition = humidity > 80 || dust > 100 || temperature > 45;
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="text-center">
                    ...
                    <div
                      className={`text-2xl font-bold ${
                        sensorData.humidity > 80 ? "text-red-400" : "text-white"
                      }`}
                    >
                      {sensorData.humidity}%
                    </div>
                  ...
                  <div className="text-center">
                    <div className="flex items-center justify-center gap-2 mb-2">
                      ...
                      <span className="text-purple-300 font-medium">Dust</span>
                    </div>
                    <div
                      className={`text-2xl font-bold ${
